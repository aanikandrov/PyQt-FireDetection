...
from PyQt5.QtWidgets import QLabel, QGraphicsView, QGraphicsPixmapItem, QGraphicsScene
...
class VideoCaptureWorker(QRunnable, QObject):
    ...
    def run(self):
        cap = cv2.VideoCapture(0 if self.path == "" else self.path) # возможно 0 или 1
